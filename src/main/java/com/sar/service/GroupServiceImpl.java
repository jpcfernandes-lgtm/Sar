...
public class GroupServiceImpl implements GroupService {
    ...
    /**
     * Formats a Group object as JSON for SSE event broadcasting.
     * 
     * @param group the group to format
     * @param eventType the type of event (e.g., "group.created", "group.updated")
     * @return JSON string representation of the group with event type
     */
    private String formatGroupAsJson(Group group, String eventType) {
        StringBuilder json = new StringBuilder();
        json.append("{\"type\":\"" + eventType + "\"")
            .append(",\"groupNumber\":\"" + group.getGroupNumber() + "\"")
            .append(",\"counter\":" + group.isCounter())
            .append(",\"lastUpdate\":\"" + group.getLastUpdate() + "\"")
            .append("}");
