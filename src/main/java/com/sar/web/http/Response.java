...
public class Response {
    ...
    private OutputStream outputStream; // output stream for streaming responses (e.g., SSE)
    /**
  ...
  /* 
    ...
    */
    ...
    /**
     * Sets the output stream for streaming responses (e.g., Server-Sent Events)
    ...
    /**
     * Gets the output stream for streaming responses
     * @return the OutputStream, or null if not set
     */
